...
/** Get the output quaternion **/
    void get_quat(void);
/** Get the output quaternion and lineare acceleration **/ //Eigene
    void get_quat_lin_acc(bool compressed = true);
...
/** Current temperature **/
    int temperature;
/** Current Axis Mapping and sign **/
    char axis_map_sign[2];
    char op_mode2;
/** Status of the Selftest for the MCU and the sensors **/
    bool statusMCU = 0;
    bool statusGYR = 0;
    bool statusMAG = 0;
    bool statusACC = 0;    
...
void writeAxisConfig(char mapping, char sign) {
    writechar(BNO055_AXIS_MAP_CONFIG_ADDR,mapping);
    ThisThread::sleep_for(10ms);
    //wait_ms(10);
    writechar(BNO055_AXIS_MAP_SIGN_ADDR,sign);
    ThisThread::sleep_for(10ms);
    //wait_ms(10);
}
